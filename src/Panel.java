...
public class Panel extends JPanel implements ActionListener {
    ...
    //flag false means game over and true means running
    boolean flag=false;
    int score=0;
    Timer timer;
    ...
    //sets initial parameters for the game and spawns the food
    ...
    public void spawnfood(){
        ...
        //we get a random multiple of 50 between 0 and 600
    ...
    public void gameover(Graphics graphic){
        ...
        graphic.setFont(new Font("Comic Sans",Font.BOLD,40));
        FontMetrics fme=getFontMetrics(graphic.getFont());
        graphic.drawString("Score:",(width-fme.stringWidth("Score:"+score))/2,graphic.getFont().getSize());
